...
export class Backend implements backendInterface {
    ...
    async listFiles(): Promise<Array<FileMeta>> {
        if (this.processError) {
            try {
    ...
    async uploadFile(arg0: string, arg1: FileType, arg2: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadFile(arg0, to_candid_FileType_n19(this._uploadFile, this._downloadFile, arg1), await to_candid_ExternalBlob_n21(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_FileMeta_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FileMeta): Promise<FileMeta> {
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_FileMeta>): Promise<Array<FileMeta>> {
    return await Promise.all(value.map(async (x)=>await from_candid_FileMeta_n14(_uploadFile, _downloadFile, x)));
}
...
function to_candid_FileType_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FileType): _FileType {
...
function to_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FileType): {
    video: null;
} | {
    image: null;
} {
